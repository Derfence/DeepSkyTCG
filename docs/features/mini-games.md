...
Pendant une partie de Quiz, Memory, Timeline ou Observatoire, le bouton de retour et le retour Android ouvrent une confirmation d'abandon. Annuler ferme la confirmation et reprend la partie. Confirmer revient au menu ; l'essai, déjà consommé au choix de la difficulté, reste utilisé sans récompense et le mini-jeu ne peut plus être rejoué avant le prochain jour UTC. Les retours depuis la sélection de difficulté, le résultat ou un écran indisponible restent immédiats.
